...
declare -A LINKS_AND_NAMES=(
    ["https://raw.githubusercontent.com/OpenNeptune3D/OpenOrangeStorm/main/img-config/printer-data/printer.cfg"]="printer.cfg"
    ["https://raw.githubusercontent.com/OpenNeptune3D/OpenOrangeStorm/main/img-config/printer-data/moonraker.conf"]="moonraker.conf"
    ["https://raw.githubusercontent.com/OpenNeptune3D/OpenOrangeStorm/main/img-config/printer-data/KAMP_Settings.cfg"]="KAMP_Settings.cfg"
    ["https://raw.githubusercontent.com/OpenNeptune3D/OpenOrangeStorm/main/img-config/printer-data/adxl.cfg"]="adxl.cfg"  
)
...
# Fluidd DB transfer
SHARE_LINK="https://raw.githubusercontent.com/OpenNeptune3D/OpenOrangeStorm/main/img-config/printer-data/data.mdb"
...
cp "$HOME/OpenOrangeStorm/img-config/spidev-fix/99-spidev.rules" /etc/udev/rules.d/

#sudo cp ~/OpenOrangeStorm/img-config/spidev-fix/rockchip-fixup.scr /boot/dtb/rockchip/overlay/
#sudo cp ~/OpenOrangeStorm/img-config/spidev-fix/rockchip-spi-spidev.dtbo /boot/dtb/rockchip/overlay/

sh -c 'echo "$(date +"%Y-%m-%d") - OpenOrangeStorm-v0.1.x-ZNP-K1" > /boot/.OpenOrangeStorm.txt'
...
"$HOME/OpenOrangeStorm/img-config/usb-storage-automount.sh"
"$HOME/OpenOrangeStorm/img-config/adb-automount.sh"
"$HOME/OpenOrangeStorm/display/display-service-installer.sh"
